%
% cam_image_unlimited_range: 
%
% generating camera images of a set of 3D points on the image plane for a
% specified pinhole camera without worrying about the image sensor size
%
% input:
...
%
function [uv,uvw,P1]=cam_image_unlimited_range(cam,Toc,P0)
...
P1=Tco(1:3,1:4)*[P0;ones(1,size(P0,2))];
